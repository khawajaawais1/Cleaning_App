        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ProgressMinutes = table.Column<int>(type: "int", nullable: false),
                    WorkerNotes = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LiveJobs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LiveJobs_Bookings_BookingId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LiveJobId = table.Column<int>(type: "int", nullable: false),
                    RequestedMinutes = table.Column<int>(type: "int", nullable: false),
                    WorkerReason = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExtensionRequests_LiveJobs_LiveJobId",
                        column: x => x.LiveJobId,
                        principalTable: "LiveJobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExtensionRequests_LiveJobId",
                table: "ExtensionRequests",
                column: "LiveJobId");

            migrationBuilder.CreateIndex(
                name: "IX_LiveJobs_BookingId",
                table: "LiveJobs",
                column: "BookingId",
                unique: true);
